...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#btnEp").click(function(){
			...
			if (reg.test(newPwd)&&reg1.test(newPwd)) {
				$.messager.alert("警告！","密码不符合规则","warning");
				return;
			}
			if (newPwd=="") {
			...
			$.post(
				'${pageContext.request.contextPath}/user/editPwd',
				{password:rePwd},
				function(data){
					if (data) {
						$.messager.alert("信息","修改密码成功,请重新登录","info");
...
<body class="easyui-layout">
 ...
 <!--  <div id="editPwdWindow" class="easyui-window" title="修改密码" style="width:300px;height:160px;padding:5px; background:#fafafa" 
    data-options="iconCls:'icon-save',modal:true,closed=true,collapsibe:false,minimizable:false,resizable:false,maximizable:false"> 
		<div class="easyui-layout" data-options="fit:true"> 
			<div data-options="region:'center'" style="padding:10px;background:#fff;border:1px solid #ccc;">
				<table cellpadding=3>
					<td>新密码：</td>
			...
			<div data-options="region:'sourth'" border="false" style="text-align: right;height:30px;line-height: 30px;"> 
				<a id="btnEp" href="javascript:void(0);" class="easyui-linkbutton" icon="icon-ok">确定</a>
				<a id="btnCancel" href="javascript:void(0);" class="easyui-linkbutton" icon="icon-cancel">取消</a>
			</div> 
		</div> 
	</div>  -->
